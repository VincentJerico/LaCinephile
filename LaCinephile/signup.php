...
<body>
    ...
    <main>
        ...
        <form method="post">
            <div style="font-family: cormorant garamond; font-size: 20px; margin: 10px; color: white;">Sign Up</div>
            ...
            <div style="font-family: cormorant garamond; font-size: 10; color: white;">Already have an account?</div>
            <a href="login.php">Sign In here</a><br><br>
